...
insert into [Hotel] ([Id], [name], [hotelURL], [hotelImage], [locationId])
VALUES (8, 'Wailea Beach Resort by Marriott','https://www.marriott.com/en-us/hotels/hnmmc-wailea-beach-resort-marriott-maui/overview/', 'https://cache.marriott.com/content/dam/marriott-renditions/HNMMC/hnmmc-maluhia-0146-hor-wide.jpg?interpolation=progressive-bilinear&downsize=1440px:*',3);
...
Values (1, 'William', 'Walker', 'W.Walker22', 'walker22@email.test', 1), (2, 'Mildred', 'Walton', 'MillieWalt', 'Millie14@email.test',0), (3, 'Ora', 'Baldwin','Baldwin16','O.Baldwin@email.test', 0);
